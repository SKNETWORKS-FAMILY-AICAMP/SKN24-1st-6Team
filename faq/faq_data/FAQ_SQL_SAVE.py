...
hyndai_faq.loc[70,'answer']='변경을 원하시면 기존 가입하신 상품 취소 후 변경 상품으로 재 가입하시면 됩니다.(단, 출고일 포함 30일 이내에만 재가입 가능합니다.)'
hyndai_faq.loc[81,'answer']='모젠고객센터(080-600-6000)로 문의 주시거나 1:1상담 문의에 올려주시면 신속하게 지원해 드리겠습니다.'
hyndai_faq.loc[157,'answer']='블루링크를 가입하시면 차량 원격제어, 안전보안, 차량관리, 길 안내 서비스를 제공받으실 수 있습니다. 블루링크 자세한 서비스 안내는 아래 페이지를 참고해주세요. 블루링크 서비스 안내 ▶바로가기'
print('na값이 있나 확인해보자 :    ',hyndai_faq[hyndai_faq['answer'].isnull()].index)
...
print(hyndai_faq[hyndai_faq.isna().any(axis=1)])
